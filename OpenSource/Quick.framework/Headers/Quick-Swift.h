...
+ (void)it:(NSString *)description file:(NSString *)file line:(NSInteger)line closure:(void (^)(void))closure;
+ (void)itBehavesLike:(NSString *)name sharedExampleContext:(NSDictionary * (^)(void))sharedExampleContext file:(NSString *)file line:(NSInteger)line;
...
@interface NSException (SWIFT_EXTENSION(Quick))
@end
