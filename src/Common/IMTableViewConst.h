...
FOUNDATION_EXTERN NSString* const IMTableViewDictionaryKeyFooterText ;
FOUNDATION_EXTERN NSString* const IMTableViewDictionaryKeyTitle      ;
FOUNDATION_EXTERN NSString* const IMTableViewDictionaryKeyStyle      ;
FOUNDATION_EXTERN NSString* const IMTableViewDictionaryKeySections   ;

/*  IMTableView sections Dictionary key */
FOUNDATION_EXTERN NSString* const IMTableViewSectionDictionaryKeyHeaderText ;
FOUNDATION_EXTERN NSString* const IMTableViewSectionDictionaryKeyFooterText ;
FOUNDATION_EXTERN NSString* const IMTableViewSectionDictionaryKeyCells      ;


/*  IMTableView cell Dictionary key */
FOUNDATION_EXTERN NSString* const IMTableViewCellDictionaryKeyKey            ;
FOUNDATION_EXTERN NSString* const IMTableViewCellDictionaryKeyImageName      ;
FOUNDATION_EXTERN NSString* const IMTableViewCellDictionaryKeyDetailTitle    ;
...
FOUNDATION_EXTERN NSString* const IMTableViewCellStyleSubtitleString  ;
...
FOUNDATION_EXTERN NSString* const IMTableViewCellReuseIdentifierStyleSubtitle  ;
FOUNDATION_EXTERN NSString* const IMTableViewCellReuseIdentifierStyleTextfield ;
...
FOUNDATION_EXTERN NSString* const IMTableViewCellReuseIdentifierStylePassword  ;
